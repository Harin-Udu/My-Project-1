...
Steps: 
  ...
  5. IMPORTANT:- Download the needed libraries, for this run this code in the terminal (no need if already downloaded),
...
Steps:
  ...
  6. IMPORTANT:- Download the needed libraries, for this run this code in the terminal (no need if already downloaded),
...
2.1.2. salon folder
   ...
   This is where all the content shown in the webpage is created. Each page is seperately made using a html which is in salon/templates/salon and a seperate css which is in salon/static/salon/css
